    ...
    for h in holdings:
        ...
        if df.empty or len(df) < 30:
            ...
            analysis = {
                ...
                "pnl": h["pnl"],
                "pnlPercentage": h["pnlPercentage"],
                "ema20": stock_score_data.get("ema20", round(ltp, 2)),
                "sma50": stock_score_data.get("sma50", round(ltp, 2)),
                "sma200": stock_score_data.get("sma200", round(ltp, 2)),
                "rsi14": stock_score_data.get("rsi14", 50.0),
