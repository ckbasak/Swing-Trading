...
async def strategy_action(chat_id: int, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        specs_text = """• **Target Universe**: Multi-Asset (Nifty 50, Midcap Momentum, Sector ETFs)
• **Entry Trigger**: Unified Multi-Engine Quantitative Breakout
• **Risk Allocation**: Portfolio Risk Budgeting & Dynamic Allocation
• **Holding Defense**: Stateful LangGraph Workflow Engine"""
        
        msg = f"⚡ **Master Unified Multi-Strategy System**\n\n"
