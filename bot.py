...
def main():
    ...
    # Configure Cloud Test Scan Job to run at 13:45 IST today
    test_time_1345 = datetime.time(hour=13, minute=45, second=0, tzinfo=tz)
    app.job_queue.run_daily(
        daily_scan_job,
        time=test_time_1345,
        days=(0, 1, 2, 3, 4, 5, 6),
    ...
    logger.info("Cloud test scan job scheduled for 13:45 IST.")
